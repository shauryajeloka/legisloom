              ...
              <ul className="space-y-4">
                {bill.versions.map((version, index) => (
                  <li key={index} className="border-b pb-3 last:border-b-0">
                    ...
                    <a href={version.url} className="text-blue-600 hover:underline text-sm" target="_blank" rel="noopener noreferrer">
                      View Document
                    </a>
                  </li>
                ))}
              ...
              <ul className="space-y-4">
                {bill.documents.map((document, index) => (
                  <li key={index} className="border-b pb-3 last:border-b-0">
                    ...
                    <a href={document.url} className="text-blue-600 hover:underline text-sm" target="_blank" rel="noopener noreferrer">
                      View Document
                    </a>
                  </li>
                ))}
